...
contract DappTest is DSTest, ShellSetup {
    ...
    function testSwapByOriginAtoBthenBtoAthenAtoCthenCtoB () public {
        ...
        uint256 swap1 = pool.swapByOrigin(100 * ( 10 ** 18 ), address(testA), address(testB));
        ...
        uint256 swap2 = pool.swapByOrigin(100 * ( 10 ** 18 ), address(testB), address(testA));
        ...
        uint256 swap3 = pool.swapByOrigin(100 * ( 10 ** 18 ), address(testA), address(testC));
        ...
        uint256 swap4 = pool.swapByOrigin(100 * ( 10 ** 18 ), address(testC), address(testB));
