...
library LoihiMath {
    ...
    function calculateMembrane (LoihiRoot.Shell shell, uint256[] memory _bals, uint256 _oGLiq, uint256 _nGLiq) internal returns (int256 shells_, int256 _psi) {
    ...
    function detectHalts (LoihiRoot.Shell shell, uint256 _oGLiq, uint256 _nGLiq, uint256[] memory _oBals, uint256[] memory _nBals) internal {
