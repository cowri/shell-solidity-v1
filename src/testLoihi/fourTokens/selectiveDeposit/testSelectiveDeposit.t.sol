...
contract SelectiveDepositTest is LoihiSetup, DSMath, DSTest {
    ...
    // function testProportionalDepositIntoModeratelyUnbalancedShell () public {
    //     deposit(1, dai, 100*WAD, usdc, 90*(10**6), usdt, 80*(10**6), susd, 30*WAD);
    ...
    //     uint256 shellsMinted = l1.proportionalDeposit(150*WAD);
    ...
    //     assertEq(daiBalAfter - daiBalBefore, 44999999999967309274);
    //     assertEq(usdcBalAfter - usdcBalBefore, 45*WAD);
    //     assertEq(usdtBalAfter - usdtBalBefore, 45*WAD);
    //     assertEq(susdBalAfter - susdBalBefore, 15*WAD);
    //     assertEq(shellsMinted, 149925008875275011288);

    // }

    // function testProportionalDepositIntoUnbalancedShells () public {
    //     deposit(1, dai, 90*WAD, usdc, 125*(10**6), usdt, 55*(10**6), susd, 30*WAD);
    ...
    //     assertEq(usdtBalAfter - usdtBalBefore, 45*WAD);
    //     assertEq(susdBalAfter - susdBalBefore, 15*WAD);
    //     assertEq(shellsMinted, 149751485058626386623);
