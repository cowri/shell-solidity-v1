...
contract SelectiveWithdrawTest is LoihiSetup, DSMath, DSTest {
    ...
    function testExecuteSelectiveWithdrawBalancedWithdraw10Dai10Usdc10Usdt2Point5SusdFrom300Proportional () public {
    ...
    function testExecuteSelectiveWithdrawModeratelyUnbalancedWithdraw5Dai1Usdc3Usdt1SusdFrom80Dai100Usdc85Usdt35Susd () public {
    ...
    function testExecuteSelectiveWithdrawPartialLowerSlippage5Dai5Usdc47Usdt16SusdFromProportional300 () public {
    ...
    function testExecuteSelectiveWithdrawPartialLowerSlippage3Dai60Usdc30Usdt1SusdFrom80Dai100Usdc100Usdt23Susd () public {
    ...
    function testExecuteSelectiveWithdrawPartialUpperSlippage0Point001Dai40Usdc40Usdt10SusdFromProportional300 () public {
        l1.proportionalDeposit(300*WAD);
    ...
    function testExecuteSelectiveWithdrawPartialLowerAntiSlippageNoWithdraw40Dai0Usdc40Usdt0SusdFrom95Dai55Usdc95Usdt15Susd () public {
    ...
    function testExecuteSelectiveWithdrawPartialLowerAntiSlippageWithWithdraw0Point0001Dai41Usdc41Usdt1SusdFrom55Dai95Usdc95Usdt15Susd () public {
    ...
    function testExecuteSelectiveWithdrawPartialUpperAntiSlippage0Dai50Usdc0Usdt18SusdFrom90Dai145Usdc90Usdt50Susd () public {
    ...
    function testExecuteSelectiveWithdrawFullUpperSlippage8Dai2Usdc8Usdt2SusdFrom90Dai145Usdc90Usdt50Susd () public {
        uint256 startingShells = deposit(dai, 90*WAD, usdc, 145*(10**6), usdt, 90*(10**6), susd, 50*WAD);
        uint256 viewBurned = viewWithdraw(dai, 8e18, usdc, 2e6, usdt, 8e6, susd, 2e18);
        uint256 shellsBurned = withdraw(dai, 8e18, usdc, 2e6, usdt, 8e6, susd, 2e18);
        assertEq(shellsBurned, 20085523001309582294);
        assertEq(shellsBurned, viewBurned);
        emit log_named_uint("starting shells", startingShells);
        emit log_named_uint("view", viewBurned);
        emit log_named_uint("shells", shellsBurned);
    }

    function testExecuteSelectiveWithdrawFullLowerSlippage0Dai1Usdc7Usdt2SusdFrom95Dai95Usdc55Usdt15Susd () public {
    ...
    function testExecuteSelectiveWithdrawFullLowerAntiSlippageNoWithdraw5Dai5Usdc0Usdt0SusdFrom95Dai95Usdc55Usdt15SusdWITHCHAICUSDC () public {
        uint256 startingShells = deposit(dai, 95*WAD, usdc, 95*(10**6), usdt, 55*(10**6), susd, 15*WAD);
    ...
    function testExecuteSelectiveWithdrawFullLowerAntiSlippageNoWithdraw5Dai5Usdc0Usdt0SusdFrom95Dai95Usdc55Usdt15Susd () public {
        uint256 startingShells = deposit(dai, 95*WAD, usdc, 95*(10**6), usdt, 55*(10**6), susd, 15*WAD);
    ...
    function testExecuteSelectiveWithdrawFullLowerAntiSlippageWithdraw5Dai5Usdc0Point5Usdt0Point2SusdFrom95Dai95Usdc55Usdt15Susd () public {
        uint256 startingShells = deposit(dai, 95*WAD, usdc, 95*(10**6), usdt, 55*(10**6), susd, 15*WAD);
    ...
    function testExecuteSelectiveWithdrawFullUpperAntiSlippage5Dai2SusdFrom145Dai90Usdc90Usdt50SusdWITHCDAI () public {
    ...
    function testExecuteSelectiveWithdrawFullUpperAntiSlippage5Dai2SusdFrom145Dai90Usdc90Usdt50Susd () public {
        uint256 startingShells = deposit(dai, 145*WAD, usdc, 90*(10**6), usdt, 90*(10**6), susd, 50*WAD);
    ...
    function testExecuteSelectiveWithdrawMegaWithdrawDirectUpperToLower95Usdt35SusdFrom90Dai90Usdc145Usdt50Susd () public {
    ...
    function testExecuteSelectiveWithdrawMegaWithdrawIndirectLowerToUpperNoWithdraw11Dai74Usdc74UsdtFrom55Dai95Usdc95Usdt15Susd () public {
    ...
    function testExecuteSelectiveWithdrawMegaWithdrawIndirectLowerToUpper11Dai74Usdc74Usdt0Point0001From55Dai95Usdc95Usdt15Susd () public {
        uint256 startingShells = deposit(dai, 55*WAD, usdc, 95*(10**6), usdt, 95*(10**6), susd, 15*WAD);
    ...
    function testExecuteProportionalWithdrawFromUnbalancedShell () public {
