...
//         assertEq(shellsBurned, 32516249891619586893);
//     }
...
//         assertEq(shellsBurned, 10004999966652689992);
//     }
...
//         assertEq(shellsBurned, 73172628733109843375);
//     }
...
//         assertEq(shellsBurned, 94125748156973638854);
//     }
...
//         assertEq(shellsBurned, 90246972113450820395);
//     }
...
//         assertEq(shellsBurned, 80021272383900682113);
//     }
...
//         assertEq(shellsBurned, 83022872742313265405);
//     }
...
//         assertEq(shellsBurned, 68025384583345188710);
//     }
...
//         assertEq(shellsBurned, 10074707591326212325);
//     }
...
//         assertEq(shellsBurned, 20095567018783175759);
//     }
...
//         assertEq(shellsBurned, 10136642711536986988);
//     }
...
//         assertEq(shellsBurned, 9997945192306006090);
//     }
...
//         assertEq(shellsBurned, 10699493832508458308);
//     }
...
//         assertEq(shellsBurned, 6997784565048389335);
//     }
...
//         assertEq(shellsBurned, 130104191583020010270);
//     }
...
//         assertEq(shellsMinted, 159185265918231872051);
//     }
...
//         assertEq(shellsMinted, 159185363052799157790);
//     }
