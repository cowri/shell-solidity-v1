...
// contract ViewSelectiveWithdrawTest is LoihiSetup, DSMath, DSTest {
...
//         uint256 shellsBurned = viewWithdraw(dai, 10*WAD, usdc, 10*(10**6), usdt, 10*(10**6), susd, 2500000000000000000);
...
//         uint256 shellsBurned = viewWithdraw(dai, 5*WAD, usdc, 10**6, usdt, 3*(10**6), susd, WAD);
...
//         uint256 shellsBurned = viewWithdraw(dai, 5*WAD, usdc, 5*(10**6), usdt, 47*(10**6), susd, 16*WAD);
...
//         uint256 shellsBurned = viewWithdraw(dai, 3*WAD, usdc, 60*(10**6), usdt, 30*(10**6), susd, 1*WAD);
...
//         l1.proportionalDeposit(300*WAD);
//         uint256 shellsBurned = viewWithdraw(dai, WAD/1000, usdc, 40*(10**6), usdt, 40*(10**6), susd, 10*WAD);
...
//         uint256 shellsBurned = viewWithdraw(dai, 40*WAD, usdc, 0, usdt, 40*(10**6), susd, 0);
...
//         uint256 shellsBurned = viewWithdraw(dai, WAD/10000, usdc, 41*(10**6), usdt, 41*(10**6), susd, WAD);
...
//         uint256 shellsBurned = viewWithdraw(dai, 0, usdc, 50*(10**6), usdt, 0, susd, 18*WAD);
...
//         uint256 startingShells = deposit(dai, 90*WAD, usdc, 145*(10**6), usdt, 90*(10**6), susd, 50*WAD);
//         uint256 shellsBurned = viewWithdraw(dai, 5*WAD, usdc, 0, usdt, 5*(10**6), susd, 0);
...
//         uint256 startingShells = deposit(dai, 90*WAD, usdc, 145*(10**6), usdt, 90*(10**6), susd, 50*WAD);
//         uint256 shellsBurned = viewWithdraw(dai, 8*WAD, usdc, 2*(10**6), usdt, 8*(10**6), susd, 2*WAD);
...
//         uint256 shellsBurned = viewWithdraw(dai, 0, usdc, 10**6, usdt, 7*(10**6), susd, 2*WAD);
...
//         uint256 startingShells = deposit(dai, 95*WAD, usdc, 95*(10**6), usdt, 55*(10**6), susd, 15*WAD);
//         uint256 shellsBurned = viewWithdraw(dai, 5*WAD, usdc, 5*(10**6), usdt, 0, susd, 0);
...
//         uint256 startingShells = deposit(dai, 95*WAD, usdc, 95*(10**6), usdt, 55*(10**6), susd, 15*WAD);
//         uint256 shellsBurned = viewWithdraw(dai, 5*WAD, usdc, 5*(10**6), usdt, (10**6)/2, susd, WAD/5);
...
//         uint256 shellsBurned = viewWithdraw(dai, 5*WAD, usdc, 0, usdt, 0, susd, 2*WAD);
...
//         uint256 shellsBurned = viewWithdraw(dai, 0, usdc, 0, usdt, 95*(10**6), susd, 35*WAD);
...
//         uint256 shellsMinted = viewWithdraw(dai, 11*WAD, usdc, 74*(10**6), usdt, 74*(10**6), susd, 0);
...
//         uint256 startingShells = deposit(dai, 55*WAD, usdc, 95*(10**6), usdt, 95*(10**6), susd, 15*WAD);
//         uint256 shellsMinted = viewWithdraw(dai, 11*WAD, usdc, 74*(10**6), usdt, 74*(10**6), susd, WAD/10000);
