...
//     //     deposit(1, dai, (55*WAD)/2, usdc, (95*(10**6))/2, usdt, (95*(10**6))/2, susd, (15*WAD)/2);
//     //     uint256 newShells1 = deposit(1, dai, (105*WAD)/2, usdc, 0, usdt, 0, susd, (37*WAD)/2);
//     //     deposit(2, dai, (55*WAD)/2, usdc, (95*(10**6))/2, usdt, (95*(10**6))/2, susd, (15*WAD)/2);
//     //     uint256 newShells2 = deposit(2, dai, (105*WAD)/4, usdc, 0, usdt, 0, susd, (37*WAD)/4);
//     //     newShells2 += deposit(2, dai, (105*WAD)/4, usdc, 0, usdt, 0, susd, (37*WAD)/4);
//     //     assertEq(newShells1, newShells2);
//     // }

//     // function testDepositContinuityMegaDepositIndirectUpperToLower165Dai165UsdtInto90Dai145Usdc90Usdt50Susd () public {
//     //     deposit(1, dai, (90*WAD)/2, usdc, (145*(10**6))/2, usdt, (90*(10**6))/2, susd, (50*WAD)/2);
//     //     uint256 newShells1 = deposit(1, dai, (165*WAD)/2, usdc, 0, usdt, (165*(10**6))/2, susd, 0);
//     //     deposit(2, dai, (90*WAD)/2, usdc, (145*(10**6))/2, usdt, (90*(10**6))/2, susd, (50*WAD)/2);
//     //     uint256 newShells2 = deposit(2, dai, (165*WAD)/4, usdc, 0, usdt, (165*(10**6))/4, susd, 0);
//     //     newShells2 += deposit(2, dai, (165*WAD)/4, usdc, 0, usdt, (165*(10**6))/4, susd, 0);
//     //     assertEq(newShells1, newShells2);
//     // }
...
//     //     deposit(1, dai, (90*WAD)/2, usdc, (145*(10**6))/2, usdt, (90*(10**6))/2, susd, (50*WAD)/2);
//     //     uint256 newShells1 = deposit(1, dai, (165*WAD)/2, usdc, ((10**6)/10000)/2, usdt, (165*(10**6))/2, susd, WAD/4);
//     //     deposit(2, dai, (90*WAD)/2, usdc, (145*(10**6))/2, usdt, (90*(10**6))/2, susd, (50*WAD)/2);
//     //     uint256 newShells2 = deposit(2, dai, (165*WAD)/4, usdc, ((10**6)/10000)/4, usdt, (165*(10**6))/4, susd, WAD/8);
//     //     newShells2 += deposit(2, dai, (165*WAD)/4, usdc, ((10**6)/10000)/4, usdt, (165*(10**6))/4, susd, WAD/8);
//     //     assertEq(newShells1, newShells2);
//     // }
