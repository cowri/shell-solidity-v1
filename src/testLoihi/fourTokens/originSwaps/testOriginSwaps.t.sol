...
contract OriginSwapTest is LoihiSetup, DSMath, DSTest {
    ...
    function testExecuteOriginSwapBalancedOriginSwap10DaiToUsdcWithProportional300 () public {
    ...
    function testExecuteOriginSwapNoFeeUnbalancedOriginSwap10UsdcToUsdtWith80Dai100Usdc85Usdt35Susd () public {
        deposit(1, dai, 80e18, usdc, 100e6, usdt, 85e6, susd, 35e18);
        uint256 targetAmount = l1.swapByOrigin(usdc, usdt, 10**7, 0, now+500);
        assertEq(targetAmount, 9995000);
    }

    function testExecuteOriginSwapNoFeeBalanced10PctWeightTo30PctWeight () public {
        l1.proportionalDeposit(300*WAD);
        uint256 targetAmount = l1.swapByOrigin(susd, usdt, 4*WAD, 0, now + 500);
        assertEq(targetAmount, 3998000);
    }

    function testExecuteOriginSwapPartialUpperAndLowerFeesFromUnbalancedShell10PctWeightTo30PctWeight () public {
    ...
    function testExecuteOriginSwapNoFeeBalanced30PctWeightTo30PctWeight () public {
        l1.proportionalDeposit(300*WAD);
        uint256 targetAmount = l1.swapByOrigin(dai, usdc, 10*WAD, 0, now + 500);
        assertEq(targetAmount, 9995000);
    }

    function testExecuteOriginSwapNoFeePartiallyUnbalanced30PctWeightTo10PctWeight () public {
    ...
    function testExecuteOriginSwapPartialUpperAndLowerFeesFromBalancedShell30PctWeight () logs_gas public {
        l1.proportionalDeposit(300*WAD);
        uint256 g1 = gasleft();
    ...
    function testExecuteOriginSwapPartialUpperAndLowerFeesFromBalancedShell30PctWeightCusdcCdai () logs_gas public {
    ...
    function testExecuteOriginSwapPartialUpperAndLowerSlippageFromBalancedShell30PctWeightTo10PctWeight () logs_gas public {
        l1.proportionalDeposit(300*WAD);
    ...
    function testExecuteOriginSwapFullUpperAndLowerSlippageUnbalancedShell30PctWeight () public {
    ...
    function testExecuteOriginSwapFullUpperAndLowerSlippageUnbalancedShell30PctWeightTo10PctWeight () logs_gas public {
    ...
    function testExecuteOriginSwapFullUpperAndLowerSlippageUnbalancedShell10PctWeightTo30PctWeightAsusdCusdc () public {
    ...
    function testExecuteOriginSwapFullUpperAndLowerSlippageUnbalancedShell10PctWeightTo30PctWeight () public {
        deposit(1, dai, 90*WAD, usdc, 55*(10**6), usdt, 90*(10**6), susd, 35*WAD);
    ...
    function testExecuteOriginSwapPartialUpperAndLowerAntiSlippageUnbalanced30PctWeight () public {
    ...
    function testExecuteOriginSwapPartialUpperAndLowerAntiSlippageUnbalanced10PctWeightTo30PctWeight () public {
    ...
    function testExecuteOriginSwapFullUpperAndLowerAntiSlippageUnbalanced30PctWeight () public {
    ...
    function testExecuteOriginSwapFullUpperAndLowerAntiSlippage10PctOrigin30Pct () public {
    ...
    function testExecuteOriginSwapFullUpperAndLowerAntiSlippage30pctOriginTo10Pct () public {
    ...
    function testExecuteOriginSwapFullUpperAndLowerAntiSlippage30pctOriginTo10PctChai () public {
        deposit(1, dai, 58*WAD, usdc, 90*(10**6), usdt, 90*(10**6), susd, 40*WAD);
    ...
    function testExecuteOriginSwapUpperHaltCheck30PctWeight () public {
    ...
    function testExecuteOriginSwapLowerHaltCheck30PctWeight () public {
    ...
    function testExecuteOriginSwapUpperHaltCheck10PctWeight () public {
        l1.proportionalDeposit(300*WAD);
        (bool success, bytes memory result) = address(l1).call(abi.encodeWithSignature(
    ...
    function testExecuteOriginSwapLowerhaltCheck10PctWeight () public {
        l1.proportionalDeposit(300*WAD);
        (bool success, bytes memory result) = address(l1).call(abi.encodeWithSignature(
    ...
    function testExecuteOriginSwapMegaLowerToUpperUpperToLower30PctWeight () public {
    ...
    function testExecuteOriginSwapMegaLowerToUpperUpperToLower30PctWeightCDai () public {
    ...
    function testExecuteOriginSwapMegaLowerToUpper10PctWeightTo30PctWeight () public {
    ...
    function testExecuteOriginSwapMegaUpperToLower30PctWeightTo10PctWeight () public {
    ...
    function testFailExecuteOriginSwapOriginGreaterThanBalance30Pct () public {
    ...
    function testFailExecuteOriginSwapOriginGreaterThanBalance10Pct () public {
        l1.proportionalDeposit(300*WAD);
