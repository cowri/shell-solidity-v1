...
//         // (uint totalReserves, uint256[] memory individualReserves) = l.totalReserves();
//         // emit log_named_uint("totalReserves", totalReserves);
//         // emit log_uints("individs", individualReserves);
//         amounts[0] = 0;
//         amounts[1] = 10 * (10 ** 6);
