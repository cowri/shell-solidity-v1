...
contract SelectiveDepositSuiteOne is SelectiveDepositTemplate, DSTest {
    ...
    function test_s1_selectiveDeposit_monotonicity_upper_inBounds_to_outOfBounds_noHalt () public {
    ...
    function test_s1_selectiveDeposit_monotonicity_upper_inBounds_to_outOfBounds_halt () public {
    ...
    function test_s1_selectiveDeposit_monotonicity_upper_outOfBand_outOfBounds_to_outOfBounds_noHalt_omegaUpdate () public {
    ...
    function test_s1_selectiveDeposit_monotonicity_upper_outOfBand_outOfBounds_to_outOfBounds_noHalt_noOmegaUpdate () public {
    ...
    function test_s1_selectiveDeposit_monotonicity_upper_outOfBand_outOfBounds_to_outOfBounds_halt_omegaUpdate () public {
    ...
    function test_s1_selectiveDeposit_monotonicity_upper_outOfBand_outOfBounds_to_outOfBounds_halt_noOmegaUpdate () public {
    ...
    function test_s1_selectiveDeposit_monotonicity_lower_outOfBand_outOfBounds_to_inBounds_halt_omegaUpdate () public {
    ...
    function test_s1_selectiveDeposit_monotonicity_lower_outOfBand_outOfBounds_to_inBounds_halt_noOmegaUpdate () public {
    ...
    function test_s1_selectiveDeposit_monotonicity_lower_outOfBand_outOfBounds_to_inBounds_noHalt_omegaUpdate () public {
    ...
    function test_s1_selectiveDeposit_monotonicity_lower_outOfBand_outOfBounds_to_inBounds_noHalt_noOmegaUpdate () public {
    ...
    function test_s1_selectiveDeposit_monotonicity_lower_outOfBand_outOfBounds_to_outOfBounds_halt_omegaUpdate () public {
    ...
    function test_s1_selectiveDeposit_monotonicity_lower_outOfBand_outOfBounds_to_outOfBounds_halt_noOmegaUpdate () public {
    ...
    function test_s1_selectiveDeposit_monotonicity_lower_outOfBand_outOfBounds_to_outOfBounds_noHalt_omegaUpdate () public {
    ...
    function test_s1_selectiveDeposit_monotonicity_lower_outOfBand_outOfBounds_to_outOfBounds_noHalt_noOmegaUpdate () public {
