...
contract KovanRenBtcToRenBtcAssimilator is IAssimilator {

    using ABDKMath64x64 for int128;
    using ABDKMath64x64 for uint256;

    IERC20 constant renBTC = IERC20(0xFf795577d9AC8bD7D90Ee22b6C1703490b6512FD);

    constructor () public { }

    // transfers raw amonut of renBTC in, wraps it in cDai, returns numeraire amount
    ...
    // transfers numeraire amount of renBTC in, wraps it in cDai, returns raw amount
    ...
    // takes raw amount of renBTC, unwraps that from cDai, transfers it out, returns numeraire amount
    ...
    // takes numeraire amount of renBTC, unwraps corresponding amount of cDai, transfers that out, returns numeraire amount
