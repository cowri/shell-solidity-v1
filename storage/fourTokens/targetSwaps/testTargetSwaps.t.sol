...
contract TargetSwapTest is LoihiSetup, DSMath, DSTest {
    ...
    function testExecuteTargetSwapBalancedTargetSwapDaiTo10UsdcWithProportional300 () public {
    ...
    function testExecuteTargetSwapNoFeeUnbalancedTargetSwap10UsdcToUsdtWith80Dai100Usdc85Usdt35Susd () public {
    ...
    function testExecuteTargetSwapNoFeeBalanced10PctWeightTo30PctWeight () public {
        l1.proportionalDeposit(300*WAD);
        uint256 targetAmount = l1.swapByTarget(susd, usdt, 400*WAD, 4*(10**6), now + 500);
        assertEq(targetAmount, 4002000250000000000);
    }

    function testExecuteTargetSwapNoFeeBalanced10PctWeightTo30PctWeightAUsdt () public {
        l1.proportionalDeposit(300*WAD);
        uint256 targetAmount = l1.swapByTarget(susd, ausdt, 400*WAD, 4*(10**6), now + 500);
        assertEq(targetAmount, 4002000250000000000);
    }

    function testExecuteTargetSwapPartialUpperAndLowerSlippageFromBalancedShell30PctWeight () logs_gas public {
        l1.proportionalDeposit(300*WAD);
        ...
        uint256 g2 = gasleft();
        emit log_named_uint("swap gas", g1-g2);
        assertEq(targetAmount, 40722871);
        assertEq(targetAmount, viewAmount);
    }

    function testExecuteTargetSwapPartialUpperAndLowerSLippageFromBalancedShell30PctWeightTo10PctWeight () public {
        l1.proportionalDeposit(300*WAD);
        uint256 targetAmount = l1.swapByTarget(usdc, susd, 8*WAD, 12*WAD, now+50);
        assertEq(targetAmount, 12073660);
    }

    function testExecuteTargetSwapPartialUpperAndLowerSLippageFromBalancedShell30PctWeightTo10PctWeightAsusd () public {
        l1.proportionalDeposit(300*WAD);
        uint256 targetAmount = l1.swapByTarget(usdc, asusd, 8*WAD, 12*WAD, now+50);
        assertEq(targetAmount, 12073660);
    }

    function testExecuteTargetSwapPartialUpperAndLowerSlippageFromUnbalancedShell10PctWeightTo30PctWeight () public {
    ...
    function testExecuteTargetSwapNoSlippagePartiallyUnbalanced30PctWeightTo10PctWeight () public {
        deposit(dai, 80*WAD, usdc, 10**8, usdt, 85*(10**6), susd, 35*WAD);
        uint256 targetAmount = l1.swapByTarget(usdc, susd, 31*(10**6), 3*WAD, now+50);
        assertEq(targetAmount, 3001500);
    }

    function testExecuteTargetSwapNoSlippagePartiallyUnbalanced30PctWeightTo10PctWeightCUsdc () public {
    ...
    function testExecuteTargetSwapFullUpperAndLowerSlippageUnbalancedShell30PctWeight () logs_gas public {
    ...
    function testExecuteTargetSwapFullUpperAndLowerSlippageUnbalancedShell30PctWeightTo10PctWeight () logs_gas public {
    ...
    function testExecuteTargetSwapFullUpperAndLowerSlippageUnbalancedShell10PctWeightTo30PctWeight () public {
    ...
    function testExecuteTargetSwapPartialUpperAndLowerAntiSlippageUnbalanced30PctWeight () public {
    ...
    function testExecuteTargetSwapPartialUpperAndLowerAntiSlippageUnbalanced10PctWeightTo30PctWeightChai () public {
    ...
    function testExecuteTargetSwapPartialUpperAndLowerAntiSlippageUnbalanced10PctWeightTo30PctWeight () public {
        deposit(dai, 135*WAD, usdc, 90*(10**6), usdt, 90*(10**6), susd, 25*WAD);
        uint256 targetAmount = l1.swapByTarget(susd, dai, 11*WAD, 10*WAD, now+50);
        assertEq(targetAmount, 9993821361386267461);
    }

    function testExecuteTargetSwapPartialUpperAndLowerAntiSlippageUnbalanced30PctWeightTo10PctWeight () public {
    ...
    function testExecuteTargetSwapFullUpperAndLowerAntiSlippageUnbalanced30PctWeight () public {
    ...
    function testExecuteTargetSwapFullUpperAndLowerAntiSlippage10PctOrigin30PctTarget () public {
    ...
    function testExecuteTargetSwapFullUpperAndLowerAntiSlippage30pctOriginTo10PctCDai () public {
    ...
    function testExecuteTargetSwapFullUpperAndLowerAntiSlippage30pctOriginTo10Pct () public {
        deposit(dai, 58*WAD, usdc, 90*(10**6), usdt, 90*(10**6), susd, 40*WAD);
        uint256 targetAmount = l1.swapByTarget(dai, susd, 10*WAD, 2349000000000000000, now+50);
        assertEq(targetAmount, 2332615973232859927);
    }

    function testExecuteTargetSwapMegaLowerToUpperUpperToLower30PctWeight () public {
    ...
    function testExecuteTargetSwapMegaLowerToUpper10PctWeightTo30PctWeight () public {
    ...
    function testExecuteTargetSwapMegaUpperToLower30PctWeightTo10PctWeight () public {
    ...
    function testExecuteTargetSwapUpperHaltCheck30PctWeight () public {
    ...
    function testExecuteTargetSwapLowerHaltCheck30PctWeight () public {
    ...
    function testExecuteTargetSwapUpperHaltCheck10PctWeight () public {
        l1.proportionalDeposit(300*WAD);
        (bool success, bytes memory result) = address(l1).call(abi.encodeWithSignature(
    ...
    function testExecuteTargetSwapLowerhaltCheck10PctWeight () public {
        l1.proportionalDeposit(300*WAD);
        (bool success, bytes memory result) = address(l1).call(abi.encodeWithSignature(
    ...
    function testExecuteTargetSwapNoFeesPartiallyUnbalanced10PctTarget () public {
        deposit(dai, 80*WAD, usdc, 100*(10**6), usdt, 85*(10**6), susd, 35*WAD);
        uint256 originAmount = l1.swapByTarget(dai, susd, 500*WAD, 3*WAD, now+50);
        assertEq(originAmount, 3001500187500000000);
    }

    function testFailExecuteTargetSwapTargetGreaterThanBalance30Pct () public {
    ...
    function testFailExecuteTargetSwapTargetGreaterThanBalance10Pct () public {
        l1.proportionalDeposit(300*WAD);
